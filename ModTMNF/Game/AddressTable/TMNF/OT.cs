...
namespace ModTMNF
{
    ...
    static class OT
    {
        ...
        public static class CGameCtnApp
        {
            public static Type BaseType = typeof(OT.CGameApp);
            public static int StructSize = 1040;
            public static int ReplayRecord = 464;// type:CGameCtnReplayRecord
        }

        public static class CTrackMania
        {
            public static Type BaseType = typeof(OT.CGameCtnApp);
            public static int StructSize = 1516;
            public static int Race = 1108;// type:CTrackManiaRace
        }
        ...
        public static class CGameNod
        {
            public static Type BaseType = typeof(OT.CMwNod);
            public static int StructSize = 28;// GUESSED (last accessed offset is 24, first offset accessed in CGamePlayground is 28)
        }

        public static class CGamePlayground
        {
            public static Type BaseType = typeof(OT.CGameNod);
            public static int StructSize = 32;// GUESSED (last accessed offset is 28, first offset accessed in CGameRace is 32)
        }

        public static class CGameRace
        {
            public static Type BaseType = typeof(OT.CGamePlayground);
            public static int StructSize = 300;// GUESSED (last accessed offset is 180, first offset accessed in CTrackMania is 300)
        }

        public static class CMwCmdBufferCore
        {
            public static Type BaseType = typeof(OT.CMwNod);
            public static int StructSize = 264;
            public static int MediaBlockTimerAdapter = 20;// type:CMwTimerAdapter
            public static int Timer = 112;// type:CMwTimer
            public static int TimerAdapter = 160;// type:CMwTimerAdapter
        }

        public static class CGameCtnReplayRecord
        {
            public static Type BaseType = typeof(OT.CMwNod);
            public static int StructSize = 76;
            public static int Ghosts = 24;// type:CFastArray
            public static int Challenge = 38;// NOTE: May be a fast array, but pointing to the pointer (it's not a double pointer so maybe not a fast array)
            public static int ReplayFiles = 48;// type:CFastArray
        }
        ...
        public static class SInputActionDesc
        {
            public static Type BaseType = null;
            public static int StructSize = 20;
            public static int Unk_0 = 0;
            public static int Unk_4 = 4;
            public static int Name = 8;
            public static int Unk_12 = 12;
            public static int Unk_16 = 16;
        }
        ...
        public static class CMwTimerAdapter
        {
            public static Type BaseType = null;
            public static int StructSize = 32;
            public static int Timer = 0;// type:CMwTimer
            public static int ReferenceSystemTime = 4;
            public static int RelativeSpeed = 8;
            public static int ReferenceGameTime = 12;
            public static int ReferenceRaceTime = 16;
            public static int TimeAtHumanTick = 20;
            public static int DeltaTime = 24;
            public static int TickTime = 28;
        }
        ...
        public static class CMwTimer
        {
            ...
            public static int Unk_0 = 0;
            public static int Unk_4 = 4;
            public static int TickTime = 8;
            public static int FrameTime = 12;
            public static int FrameTimeInSeconds = 16;
            public static int FrameRate = 20;
            public static int InitialPerformanceCounter = 24;// type:int64
            public static int InitialSystemTime = 32;
            public static int Unk_36 = 36;
            public static int Unk_40 = 40;
            public static int Unk_44 = 44;
        }
